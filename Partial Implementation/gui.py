...
def screenForDeafMute():
    ...
    closeButton = Button(windowForMute, text='x',
                         fg='red', command=destroyMuteScreen)
...
def screenForNormal():
    ...
    errorLabel.place(x=70, y=100)
    closeButton = Button(windowForNormal, text='x',
                         fg='red', command=destroyNormalScreen)
    closeButton.place(x=10, y=270)
...
introductionLabel = Label(
    root, text="DRISHYAM : An Interpreter for Deaf and Mute")
...
introductionLabelPara1 = Label(
    root, text="Firstly select one of the category below")
introductionLabelPara1.place(x=10, y=70)

button = Button(root, text="Normal", fg="black",
                command=screenForNormal).place(x=50, y=150)
button = Button(root, text="Deaf/Mute", fg="black",
                command=screenForDeafMute).place(x=180, y=150)
