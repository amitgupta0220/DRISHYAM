...
def screenForMute():
  ...
  drop = OptionMenu( windowForMute , clicked , *options )
  drop.pack()
...
button = Button( root , text = "Normal",fg="black" , command = screenForMute  ).place(x=50,y=150)
button = Button( root , text = "Deaf/Mute",fg="black" , command = screenForMute  ).place(x=180,y=150)
